    ...
    <div class="tbr_body mt-2">
        ...
        <table class="tbr_table--striped table-striped" style="width: 100%">
            <tr style="border-bottom: 1px solid #000000;">
                <th class="tbr_font-bold" style="height: 30px; width: 15%; padding: 0 20px;">TANGGAL</th>
                <th class="tbr_font-bold" style="height: 30px; width: 25%; padding: 0 20px;">OLEH</th>
                <th class="tbr_font-bold" style="height: 30px; width: 10%; padding: 0 20px;">SEBAGAI</th>
                <th class="tbr_font-bold" style="height: 30px; width: 50%; padding: 0 20px;">HASIL PEMERIKSAAN & PERKEMBANGAN</th>
            </tr>
            @foreach ($inspections as $inspection)
                <tr>
                    <td style="width: 15%; padding: 0 20px">{{ formatDate($inspection->test_date, 'd/m/Y \j\a\m H:i') }}</td>
                    <td style="width: 25%; padding: 0 20px">{{ $inspection->user_name }}</td>
                    <td style="width: 10%; padding: 0 20px">{{ $inspection->user_role }}</td>
                    <td style="width: 50%; padding: 0 20px">{{ $inspection->test_result }}</td>
                </tr>
            @endforeach
        </table>
    </div>
