...
<body style="background-image: url('{{ public_path('assets/images/background/Bg-Assesment.png') }}'); background-repeat: no-repeat; background-position: center;">
            ...
            <tr>
                ...
                <td style="width: 20%; vertical-align: top;">
                    <table style="width: 100%; text-align: right;">
                        ...
                        <tr>
                            <td>Kunjungan {{ $soap->visit_number }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <div class="tbr_body mt-2">
        ...
        <table style="width: 100%; margin-top: 20px">
            <tr>
                <th>
                    <td class="tbr_font-bold" align="left" style="background-color: #0D9A89; color: #FFFFFF; padding: 0 20px; height: 30px;">{{ $resume->subAssesment->template->name }}</td>
                    <td class="tbr_font-bold" align="right" style="background-color: #0D9A89; color: #FFFFFF; padding: 0 20px; height: 30px;">SOAP #{{ $soap->soap_number }}</td>
                </th>
            </tr>
        </table>
        <table style="width: 100%">
            <tr>
                <th>
                    <td class="tbr_font-bold" align="center" style="height: 30px; border-bottom: 1px solid #000000;">ANAMNESIS</td>
                </th>
            </tr>
        </table>
        <table class="tbr_table--striped table-striped" style="width: 100%">
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Keluhan utama</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->tekanan_darah }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Riwayat penyakit sekarang</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->riwayat_penyakit_sekarang }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Riwayat penyakit dahulu</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->riwayat_penyakit_dahulu }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Riwayat penyakit keluarga</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->riwayat_penyakit_keluarga }}</td>
            </tr>
        </table>
        <table style="width: 100%">
            <tr>
                <th>
                    <td class="tbr_font-bold" align="center" style="height: 30px; border-bottom: 1px solid #000000;">PEMERIKSAAN FISIK</td>
                </th>
            </tr>
        </table>
        <table class="tbr_table--striped table-striped" style="width: 100%">
            ...
            <tr>
                ...
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->frekuensi_nadi }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Frekuensi napas</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->frekuensi_napas }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Suhu</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->suhu_badan }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Berat badan</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->berat_badan }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Tinggi badan</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->tinggi_badan }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">GDS</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->gds }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Keadaan umum</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->keadaan_umum }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Tindakan resusitasi</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->tindakan_resusitasi }}</td>
            </tr>
        </table>
        <table style="width: 100%">
            <tr>
                <th>
                    <td class="tbr_font-bold" align="center" style="height: 30px; border-bottom: 1px solid #000000;">PEMERIKSAAN PENUNJANG</td>
                </th>
            </tr>
        </table>
        <table class="tbr_table--striped table-striped" style="width: 100%">
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">Laboratorium</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $laboratorium->count() > 0 ? $laboratorium->unique_id : '-' }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">EKG</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->ekg }}</td>
            </tr>
            <tr>
                <td class="first-table" style="width: 50%; padding: 0 20px;">X - Ray</td>
                <td class="middle-table" style="width: 5%">:</td>
                <td style="width: 45%">{{ $resume->xray }}</td>
            </tr>
        </table>
        <table style="width: 100%">
            <tr>
                <th>
                    <td class="tbr_font-bold" align="center" style="height: 30px; border-bottom: 1px solid #000000;">DIAGNOSA UTAMA</td>
                </th>
            </tr>
        </table>
        <table class="tbr_table--striped table-striped" style="width: 100%">
        ...
        <table style="width: 100%">
            <tr>
                <th>
                    <td class="tbr_font-bold" align="center" style="height: 30px; border-bottom: 1px solid #000000;">DIAGNOSA SEKUNDER</td>
                </th>
            </tr>
        </table>
        <table class="tbr_table--striped table-striped" style="width: 100%">
        ...
        <table style="width: 100%">
            <tr>
                <th>
                    <td class="tbr_font-bold" align="center" style="height: 30px; border-bottom: 1px solid #000000;">TINDAKAN</td>
                </th>
            </tr>
        </table>
        <table class="tbr_table--striped table-striped" style="width: 100%">
